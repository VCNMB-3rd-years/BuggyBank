...
class FragProfile : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnSave?.setOnClickListener {
            ...
            updateDetails(name, email, age, phone, surname, address, profileImageUri)
        }
        if (uid != null) {
                ...
                .addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            phoneTextInputLayout?.editText?.setText("")
                            surnameTextInputLayout?.editText?.setText("")
                            addressTextInputLayout?.editText?.setText("")
    ...
    private fun updateDetails(name: String, email: String, age: String, phone: String, surname: String, address: String, profileImageUri: Uri? = null) {
        val uid = FirebaseAuth.getInstance().currentUser?.uid
        if (uid != null) {
            FirebaseDatabase.getInstance().getReference("users").child(uid).child("details")
